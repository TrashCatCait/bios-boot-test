...
guifg: db 0x0f
cur_char: db 0x00
buffercurrent: dd 0x000a0000 ;set the base addr of the buffer for GUI printing
;But also is overwriteable should we need to change it but I don't for see that
